...
export default function Footer() {
    return (
        <>
            <footer className="footer bg-base-100 text-content items-center p-4 border-t">
                <nav className="md:grid-flow-col gap-4 md:place-self-center md:justify-self-start text-gray-400">
